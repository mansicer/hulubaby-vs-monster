...
本项目的所有运行实例均在**OpenJDK 15.0**环境下完成.
...
项目中已内置了一段精彩游戏录像, 可以直接通过存档回放功能查看, 录像位置在根目录下的`./hulu_record_video`文件夹中.

**关于部分功能**:

由于Mac文件系统的路径问题, 本游戏在macOS系统下部分与I/O相关的功能可能出现异常, 如导入录像. 在Windows系统下功能正常.
